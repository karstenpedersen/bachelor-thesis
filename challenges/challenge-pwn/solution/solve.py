...
server = SSHTunnelForwarder(
    ...
    ssh_username="gl",
    ssh_password="hf",
    # accept-new host keys (equiv of StrictHostKeyChecking=accept-new)
    # sshtunnel by default loads known hosts and auto-adds unknown ones
    allow_agent=False,
    host_pkey_directories=None,  # skip loading ~/.ssh, just AutoAdd
